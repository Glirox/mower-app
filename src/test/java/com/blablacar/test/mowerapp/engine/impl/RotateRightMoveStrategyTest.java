 ...
 * @since 3 août 2019
 */
public class RotateRightMoveStrategyTest {

	private RotateRightMoveStrategy strategy;
	...
	public void testRotateFromNorth() {
		assertThat(strategy.move(Location.of(5, 5, NORTH))).isEqualTo(Location.of(5, 5, EAST));
	}

	@Test
	public void testRotateFromSouth() {
		assertThat(strategy.move(Location.of(5, 5, SOUTH))).isEqualTo(Location.of(5, 5, WEST));
	}

	@Test
	public void testRotateFromEast() {
		assertThat(strategy.move(Location.of(5, 5, EAST))).isEqualTo(Location.of(5, 5, SOUTH));
	}

	@Test
	public void testRotateFromWest() {
		assertThat(strategy.move(Location.of(5, 5, WEST))).isEqualTo(Location.of(5, 5, NORTH));
	}
